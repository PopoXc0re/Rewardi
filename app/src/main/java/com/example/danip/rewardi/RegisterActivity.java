...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etEmailRegister = (EditText) findViewById(R.id.email_register);
        final EditText etPasswordRegister = (EditText) findViewById(R.id.password_register);
